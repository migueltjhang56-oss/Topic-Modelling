...
Jumlah data awal sebanyak 5.204 tweet, kemudian setelah proses preprocessing diperoleh 4.780 tweet yang digunakan dalam analisis. Dataset terdiri dari dua variabel utama yaitu tanggal publikasi (date) dan isi teks tweet (text). Seluruh data menggunakan bahasa Indonesia.
